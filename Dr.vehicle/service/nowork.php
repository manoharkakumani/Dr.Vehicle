...
<ul class="topnav">
  ...
  <li><a class="active"  href="nowork.php">Free Men</a></li>
...
<center><span class="head">Ready To Work</span></center><br></br> 
  <table>
  <tr>
    <th>Service Id</th>
    <th>Name</th>
    ...
    <th>Address</th>
             ...
             <?php
  $list=mysqli_query($db ,"select * from `service` where status=0");
