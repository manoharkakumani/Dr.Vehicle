...
<ul class="topnav">
  ...
  <li><a class="active" href="vehicle.php">My vehicles</a></li>
...
<center><span class="head">My vehicles</span></center><br></br> 
  <table>
  <tr>
    <th>Reg No</th>
    <th>Type</th> 
    <th>Model</th>
            ...
            while($row_list=mysqli_fetch_assoc($list)){                
                   echo " <tr><td>".$row_list['regno']."</td><td>".$row_list['type']."</td><td>".$row_list['model']."</td></tr>";
                }
                ?>
				 </table>
             <br></br>
